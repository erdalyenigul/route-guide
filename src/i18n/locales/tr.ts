...
export default {
  ...
  van: {
    ...
    roadSurface: 'Yol yüzeyi', roadWidth: 'Yol genişliği', turnaround: 'Dönüş alanı', freecampSpots: 'Ücretsiz geceleme noktaları', paidAlternatives: 'Ücretli alternatifler', noVerifiedFreecamp: 'Doğrulanmış bir freecamp noktası bulunmuyor.', openNavigation: 'Navigasyonda aç',
    ducato: { comfortable: 'Rahat gir', caution: 'Dikkatli', leave_above: 'Üstte bırak', do_not_enter: 'Girme' },
    road: { asphalt: 'Asfalt', gravel: 'Stabilize', dirt: 'Toprak', mixed: 'Karma zemin', wide: 'Geniş yol', normal: 'Normal genişlik', narrow: 'Dar yol', very_narrow: 'Çok dar yol', steepGrade: 'Dik eğim', hairpins: 'Keskin viraj', cliffExposure: 'Uçurum kenarı', noGuardrails: 'Bariyersiz', turnaroundPossible: 'Dönüş alanı var' },
