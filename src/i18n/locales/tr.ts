...
export default {
  ...
  stop: {
    ...
    stageIncomplete: 'Rota tamamlanmadı',
    photography: 'Fotoğraf', safety: 'Güvenlik notları', markVisited: 'Ziyaret edildi işaretle', markedVisited: 'Ziyaret edildi', stageComplete: 'Rota tamamlandı', routeSkipped: 'Pas geçildi', routeSkippedHint: 'Bu durağa uğranmadı.', skipRoute: 'Pas geç', markIncomplete: 'Tamamlanmadı yap', stageCompleteHint: 'Bu durağı ortak rota ilerlemesine dahil et', stageCompleteEditableHint: 'Bu durağın ortak rota ilerleme durumunu güncelle.', stageCompleteReadOnlyHint: 'Bu ortak rota durumu yönetici tarafından güncellenir.', nightsStayedValue: '{count} gece kalındı', completionSummary: '{nights} gece · {distance} km sürüldü', completeStopTitle: 'Rota durumunu güncelle', plannedNightsValue: '{count} gece planlandı', actualNightsStayed: 'Gerçek kalınan gece', actualDistanceTravelled: 'Gerçek yapılan mesafe', plannedDistanceValue: 'Planlanan mesafe: {count} km', completeAndSave: 'Tamamla ve kaydet', editCompletion: 'Gezi bilgilerini düzenle',
    ...
    camera: 'Luna Ultra önerisi', warning: 'Varmadan önce', roadWarnings: 'Yol uyarıları', tripTools: 'Yakını keşfet', ourNotes: 'Kişisel notlar', ourExperience: 'Gezi notu', usefulLinks: 'Faydalı bağlantılar', experienceBy: '{name} · {date}', routeOriginCompleted: 'Rota başlangıcı tamamlandı', routeDestinationCompleted: 'Varış etabı tamamlandı · {distance} km', restaurants: 'Restoranlar', hiddenPlaces: 'Gizli yerler', nearbyBeaches: 'Yakındaki plajlar', interactiveMap: 'Durak haritası', noContent: 'Henüz doğrulanmış içerik eklenmedi.', verification: 'İçerik doğrulama', verificationHint: 'Operasyonel bilgiler değişebilir. Erişim, park ve tesisleri kullanmadan önce yeniden kontrol edin.', lastVerified: 'Son inceleme', sourceNote: 'Kaynak notu'
  },
  van: {
    quickDecision: 'Karavan hızlı kararı', roadAndDucato: 'Yol & Ducato', freecampAndOvernight: 'Freecamp & Geceleme', risks: 'Riskler & Bilmen Gerekenler', essentials: 'Su, WC & İhtiyaçlar', explore: 'Keşfet', summary: 'Özet',
    ducatoLabel: 'Ducato', freecampLabel: 'Freecamp', seaLabel: 'Deniz', waterLabel: 'Su', overnightLabel: 'Geceleme', suitableSpotCount: '{count} uygun nokta', beachfront: 'Deniz kenarı', seaView: 'Deniz manzarası', levelGround: 'Düz zemin', fillBeforeArrival: 'Önceden doldur', spotChoiceMatters: 'Spot seçimi önemli', verifyCurrentConditions: 'Doğrulanmamış operasyonel bilgiler var. Güncel yol ve geceleme durumunu kontrol et.',
    roadSurface: 'Yol yüzeyi', roadWidth: 'Yol genişliği', terrainProfile: 'Etap eğim profili', turnaround: 'Dönüş alanı', freecampSpots: 'Ücretsiz geceleme noktaları', paidAlternatives: 'Ücretli alternatifler', noVerifiedFreecamp: 'Doğrulanmış bir freecamp noktası bulunmuyor.', openNavigation: 'Navigasyonda aç',
    ducato: { comfortable: 'Rahat gir', caution: 'Dikkatli', leave_above: 'Üstte bırak', do_not_enter: 'Girme' },
    road: { asphalt: 'Asfalt', gravel: 'Stabilize', dirt: 'Toprak', mixed: 'Karma zemin', wide: 'Geniş yol', normal: 'Normal genişlik', narrow: 'Dar yol', very_narrow: 'Çok dar yol', steepGrade: 'Dik eğim', hairpins: 'Keskin viraj', cliffExposure: 'Uçurum kenarı', noGuardrails: 'Bariyersiz', turnaroundPossible: 'Dönüş alanı var', terrain: { gentle: 'Rahat eğim', winding: 'Virajlı', steep: 'Dik rampalı', mountainous: 'Dağlık ve zorlu' } },
    signal: { none: 'Yok', weak: 'Zayıf', medium: 'Orta', good: 'İyi', unknown: 'Bilinmiyor' }
  },
  stopLinks: { travelGuide: 'Gezi rehberi', thingsToDo: 'Yapılacaklar', beachesAndCoves: 'Plajlar ve koylar' },
  map: { title: 'Rota haritası', subtitle: 'Aktif rotadaki tüm duraklar', currentLocation: 'Mevcut konum', legend: 'Harita açıklaması', selectedStop: 'Seçili durak', mapPlaceholder: 'Etkileşimli rota önizlemesi', cityLabel: 'Rota', seaLabel: 'Kıyı', completed: 'Tamamlandı', upcoming: 'Sıradaki', viewStop: 'Durağı aç', navigate: 'Yol tarifi', navigationTarget: 'Navigasyon hedefi', openRoute: 'Rotayı görüntüle', fitRoute: 'Rotayı sığdır', collapseStopCard: 'Durak kartını kapat', expandStopCard: 'Durak kartını aç', loading: 'Harita yükleniyor', loadError: 'Harita yüklenemedi', noCoordinates: 'Durak koordinatı bulunmuyor.', missingCoordinates: 'Koordinatı eksik bazı duraklar haritada gösterilmiyor.' },
  ...
  admin: {
    privateWorkspace: 'Yönetim', roleLabel: 'Admin', loginTitle: 'Admin girişi', loginSubtitle: 'Yönetim paneline giriş yap.', loginError: 'Kullanıcı adı veya parola yanlış.', loginConnectionError: 'Sunucuya bağlanılamadı. İnternet bağlantını kontrol edip tekrar dene.', username: 'Kullanıcı adı', password: 'Parola', signIn: 'Giriş yap', accountMenu: 'Admin hesap menüsü',
    dashboardTitle: 'İçerik yönetimi', dashboardSubtitle: 'Durak açıklamalarını ve fotoğraflarını düzenleyin.', signOut: 'Çıkış yap', sharedPoolTitle: 'İçerik', sharedPoolDescription: 'Durak içeriklerini yönetin.', photoCount: '{count} fotoğraf', experienceAdded: 'Not var', experienceEmpty: 'Not yok', tripProgress: 'Gezi ilerlemesi', actualTripData: 'Gezi değerleri', progressHint: 'Planlanan değerler değişmeden kalır. Etap tamamlandığında gerçek konaklama ve mesafeyi ayrıca kaydedin.', plannedStay: 'Planlanan konaklama', plannedDistance: 'Planlanan mesafe', saveProgress: 'İlerlemeyi kaydet', progressSaved: 'Gezi ilerlemesi kaydedildi.', progressSaveError: 'Gezi ilerlemesi kaydedilemedi.',
    stopEditorSubtitle: 'Notlar ve fotoğraflar', viewStop: 'Durağı görüntüle', loadError: 'Durak içeriği yüklenemedi.', experienceSaved: 'Not kaydedildi.', saveError: 'Not kaydedilemedi.', photosUploaded: 'Fotoğraflar yüklendi.', photoLimitError: 'Bu durakta zaten 10 fotoğraf var veya seçiminiz kalan sınırı aşıyor.', uploadError: 'Fotoğraflar yüklenemedi.', coverError: 'Kapak fotoğrafı değiştirilemedi.', deleteError: 'Fotoğraf silinemedi.',
