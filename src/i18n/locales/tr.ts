...
export default {
  ...
  stop: {
    ...
    photography: 'Fotoğraf', safety: 'Güvenlik notları', markVisited: 'Ziyaret edildi işaretle', markedVisited: 'Ziyaret edildi',
  ...
  gallery: { title: 'Galeri', subtitle: 'Aktif rotadaki fotoğraflar', empty: 'Henüz fotoğraf eklenmedi', photoOf: '{stop} fotoğrafı', openPhoto: 'Fotoğrafı aç', previous: 'Önceki fotoğraf', next: 'Sonraki fotoğraf' },
  ...
  settings: { title: 'Ayarlar', subtitle: 'Route Guide sana uyum sağlasın', appearance: 'Görünüm', darkMode: 'Karanlık mod', language: 'Dil', english: 'İngilizce', turkish: 'Türkçe', storage: 'Çevrimdışı ve depolama', offlineReady: 'Uygulama kabuğu çevrimdışı kullanılabilir', localData: 'Favoriler ve ilerleme bu cihazda saklanır', management: 'Yönetim', managementTitle: 'İçerik yönetimi', managementSubtitle: 'Durak açıklamalarını ve fotoğraflarını düzenle.' },
  admin: {
    ...
    dashboardTitle: 'İçerik yönetimi', dashboardSubtitle: 'Durak açıklamalarını ve fotoğraflarını düzenleyin.', signOut: 'Çıkış yap', sharedPoolTitle: 'İçerik', sharedPoolDescription: 'Durak içeriklerini yönetin.', photoCount: '{count} fotoğraf', experienceAdded: 'Açıklama var', experienceEmpty: 'Açıklama yok',
    stopEditorSubtitle: 'Açıklama ve fotoğraflar', viewStop: 'Durağı görüntüle', loadError: 'Durak içeriği yüklenemedi.', experienceSaved: 'Açıklama kaydedildi.', saveError: 'Açıklama kaydedilemedi.', photosUploaded: 'Fotoğraflar yüklendi.', photoLimitError: 'Bu durakta zaten 10 fotoğraf var veya seçiminiz kalan sınırı aşıyor.', uploadError: 'Fotoğraflar yüklenemedi.', coverError: 'Kapak fotoğrafı değiştirilemedi.', deleteError: 'Fotoğraf silinemedi.',
    journal: 'Açıklama', experienceTitle: 'Durak açıklaması', published: 'Yayında', experienceLabel: 'Açıklama', experienceHint: 'Bu durakla ilgili notlarınızı yazın.', lastEditedBy: 'Son düzenleyen: {name} · {date}', sharedGallery: 'Fotoğraflar', photoUploadTitle: 'Fotoğraf ekle', photoUploadHint: '{count} fotoğraf daha ekleyebilirsiniz.', choosePhotos: 'Fotoğraf seç', photoCaption: 'Fotoğraf açıklaması (isteğe bağlı)', uploadPhotos: 'Fotoğrafları yükle', uploadCoverPhoto: 'Fotoğraf yükle', currentPhotos: 'Mevcut fotoğraflar', cover: 'Kapak', makeCover: 'Kapak fotoğrafı yap', deletePhoto: 'Fotoğrafı sil', noPhotos: 'Henüz fotoğraf yok', noPhotosHint: 'Bu durağa fotoğraf ekleyin.', deleteConfirmTitle: 'Fotoğraf silinsin mi?', deleteConfirmBody: 'Silinen fotoğraf geri getirilemez.', cancel: 'Vazgeç'
  },
