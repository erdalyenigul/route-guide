...
export default {
  ...
  admin: {
    privateWorkspace: 'Yönetim', loginTitle: 'Admin girişi', loginSubtitle: 'Yönetim paneline giriş yap.', loginError: 'Kullanıcı adı veya parola yanlış.', loginConnectionError: 'Sunucuya bağlanılamadı. İnternet bağlantını kontrol edip tekrar dene.', username: 'Kullanıcı adı', password: 'Parola', signIn: 'Giriş yap', accountMenu: 'Admin hesap menüsü',
