...
export default {
  ...
  map: { title: 'Rota haritası', subtitle: 'Aktif rotadaki tüm duraklar', currentLocation: 'Mevcut konum', legend: 'Harita açıklaması', selectedStop: 'Seçili durak', mapPlaceholder: 'Etkileşimli rota önizlemesi', cityLabel: 'Rota', seaLabel: 'Kıyı', completed: 'Tamamlandı', upcoming: 'Sıradaki', viewStop: 'Durağı aç', navigate: 'Yol tarifi', openRoute: 'Rotayı görüntüle', fitRoute: 'Rotayı sığdır', loading: 'Harita yükleniyor', loadError: 'Harita yüklenemedi', noCoordinates: 'Durak koordinatı bulunmuyor.', missingCoordinates: 'Koordinatı eksik bazı duraklar haritada gösterilmiyor.' },
