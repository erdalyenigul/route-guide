...
export default {
  ...
  van: {
    quickDecision: 'Camper quick decision', roadAndDucato: 'Road & Ducato', freecampAndOvernight: 'Freecamp & Overnight', risks: 'Risks & Before You Go', essentials: 'Water, WC & Supplies', explore: 'Explore', summary: 'Summary',
    ducatoLabel: 'Ducato', freecampLabel: 'Freecamp', seaLabel: 'Sea', waterLabel: 'Water', overnightLabel: 'Overnight', suitableSpotCount: '{count} suitable spots', beachfront: 'Beachfront', seaView: 'Sea view', levelGround: 'Level ground', fillBeforeArrival: 'Fill before arrival', spotChoiceMatters: 'Spot choice matters', verifyCurrentConditions: 'Some operational details are unverified. Check current road and overnight conditions.',
    roadSurface: 'Road surface', roadWidth: 'Road width', terrainProfile: 'Leg gradient profile', turnaround: 'Turnaround space', freecampSpots: 'Free overnight spots', paidAlternatives: 'Paid alternatives', noVerifiedFreecamp: 'No verified freecamp spot is available.', openNavigation: 'Open in navigation',
    ducato: { comfortable: 'Easy access', caution: 'Use caution', leave_above: 'Leave van above', do_not_enter: 'Do not enter' },
    road: { asphalt: 'Asphalt', gravel: 'Gravel', dirt: 'Dirt', mixed: 'Mixed surface', wide: 'Wide road', normal: 'Normal width', narrow: 'Narrow road', very_narrow: 'Very narrow road', steepGrade: 'Steep grade', hairpins: 'Hairpins', cliffExposure: 'Cliff edge', noGuardrails: 'No guardrails', turnaroundPossible: 'Turnaround available', terrain: { gentle: 'Gentle grades', winding: 'Winding', steep: 'Steep climbs', mountainous: 'Mountainous and demanding' } },
