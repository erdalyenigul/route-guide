...
export default {
  ...
  common: {
    ...
    free: 'Free', recommended: 'Recommended', details: 'View details', close: 'Close', current: 'Current',
  ...
  gallery: { title: 'Gallery', subtitle: 'Photos from the active route', empty: 'No photos have been added yet', photoOf: 'Photo of {stop}', openPhoto: 'Open photo', previous: 'Previous photo', next: 'Next photo' },
  ...
  settings: { title: 'Settings', subtitle: 'Make Route Guide feel like yours', appearance: 'Appearance', darkMode: 'Dark mode', language: 'Language', english: 'English', turkish: 'Turkish', storage: 'Offline & storage', offlineReady: 'App shell available offline', localData: 'Favorites and progress are stored on this device', management: 'Management', managementTitle: 'Content management', managementSubtitle: 'Edit stop descriptions and photos.' },
  admin: {
    privateWorkspace: 'Management', loginTitle: 'Admin sign in', loginSubtitle: 'Sign in to the admin panel.', loginError: 'The username or password is incorrect.', username: 'Username', password: 'Password', signIn: 'Sign in', accountMenu: 'Admin account menu',
    dashboardTitle: 'Content management', dashboardSubtitle: 'Edit stop descriptions and photos.', signOut: 'Sign out', sharedPoolTitle: 'Content', sharedPoolDescription: 'Manage stop content.', photoCount: '{count} photos', experienceAdded: 'Description added', experienceEmpty: 'No description',
    stopEditorSubtitle: 'Description and photos', viewStop: 'View stop', loadError: 'The stop content could not be loaded.', experienceSaved: 'Description saved.', saveError: 'Description could not be saved.', photosUploaded: 'Photos uploaded.', photoLimitError: 'This stop already has 10 photos, or the selection exceeds the remaining limit.', uploadError: 'Photos could not be uploaded.', coverError: 'The cover photo could not be changed.', deleteError: 'The photo could not be deleted.',
    journal: 'Description', experienceTitle: 'Stop description', published: 'Published', experienceLabel: 'Description', experienceHint: 'Write your notes about this stop.', lastEditedBy: 'Last edited by {name} · {date}', sharedGallery: 'Photos', photoUploadTitle: 'Add photos', photoUploadHint: 'You can add {count} more photos.', choosePhotos: 'Choose photos', photoCaption: 'Photo caption (optional)', uploadPhotos: 'Upload photos', uploadCoverPhoto: 'Upload photo', currentPhotos: 'Current photos', cover: 'Cover', makeCover: 'Make cover photo', deletePhoto: 'Delete photo', noPhotos: 'No photos yet', noPhotosHint: 'Add a photo to this stop.', deleteConfirmTitle: 'Delete photo?', deleteConfirmBody: 'A deleted photo cannot be recovered.', cancel: 'Cancel'
  },
