...
export default {
  ...
  stop: {
    ...
    markedVisited: 'Visited', stageComplete: 'Route complete', routeSkipped: 'Skipped', routeSkippedHint: 'This stop was not visited.', skipRoute: 'Skip', stageCompleteHint: 'Include this stop in shared trip progress', stageCompleteEditableHint: 'Update this stop in the shared route progress.', stageCompleteReadOnlyHint: 'This shared route status is managed by an administrator.', nightsStayedValue: '{count} nights stayed', completionSummary: '{nights} nights · {distance} km driven', completeStopTitle: 'Complete route', plannedNightsValue: '{count} nights planned', actualNightsStayed: 'Actual nights stayed', actualDistanceTravelled: 'Actual distance driven', plannedDistanceValue: 'Planned distance: {count} km', completeAndSave: 'Complete and save', editCompletion: 'Edit trip details', favorite: 'Add to favorites', unfavorite: 'Remove from favorites', fromPrevious: 'from previous stop', stopNavigation: 'Move between route stops', previousStop: 'Previous', nextStop: 'Next', previousStopNamed: 'Previous stop: {stop}', nextStopNamed: 'Next stop: {stop}',
