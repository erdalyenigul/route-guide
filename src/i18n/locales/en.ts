...
export default {
  ...
  admin: {
    privateWorkspace: 'Management', loginTitle: 'Admin sign in', loginSubtitle: 'Sign in to the admin panel.', loginError: 'The username or password is incorrect.', loginConnectionError: 'Could not connect to the server. Check your internet connection and try again.', username: 'Username', password: 'Password', signIn: 'Sign in', accountMenu: 'Admin account menu',
