...
export default {
  ...
  van: {
    ...
    roadSurface: 'Road surface', roadWidth: 'Road width', turnaround: 'Turnaround space', freecampSpots: 'Free overnight spots', paidAlternatives: 'Paid alternatives', noVerifiedFreecamp: 'No verified freecamp spot is available.', openNavigation: 'Open in navigation',
    ducato: { comfortable: 'Easy access', caution: 'Use caution', leave_above: 'Leave van above', do_not_enter: 'Do not enter' },
    road: { asphalt: 'Asphalt', gravel: 'Gravel', dirt: 'Dirt', mixed: 'Mixed surface', wide: 'Wide road', normal: 'Normal width', narrow: 'Narrow road', very_narrow: 'Very narrow road', steepGrade: 'Steep grade', hairpins: 'Hairpins', cliffExposure: 'Cliff edge', noGuardrails: 'No guardrails', turnaroundPossible: 'Turnaround available' },
