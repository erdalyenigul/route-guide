...
export default {
  ...
  admin: {
    ...
    dashboardTitle: 'Content management', dashboardSubtitle: 'Edit stop descriptions and photos.', signOut: 'Sign out', sharedPoolTitle: 'Content', sharedPoolDescription: 'Manage stop content.', photoCount: '{count} photos', experienceAdded: 'Description added', experienceEmpty: 'No description', tripProgress: 'Trip progress', actualTripData: 'Trip values', languageDrafts: 'Turkish and English descriptions', progressHint: 'Planned values remain unchanged. Save the actual stay and distance separately when this leg is complete.', plannedStay: 'Planned stay', plannedDistance: 'Planned distance', saveProgress: 'Save progress', progressSaved: 'Trip progress saved.', progressSaveError: 'Trip progress could not be saved.',
