...
export default {
  ...
  stop: {
    ...
    stageIncomplete: 'Leg not completed',
  ...
  admin: {
    ...
    stopEditorSubtitle: 'Description and photos', viewStop: 'View stop', loadError: 'The stop content could not be loaded.', experienceSaved: 'Turkish and English notes saved.', saveError: 'Notes could not be saved.', photosUploaded: 'Photos uploaded.', photoLimitError: 'This stop already has 10 photos, or the selection exceeds the remaining limit.', uploadError: 'Photos could not be uploaded.', coverError: 'The cover photo could not be changed.', deleteError: 'The photo could not be deleted.',
