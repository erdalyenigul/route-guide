...
export type StopRow = VerificationColumns & {
  ...
  region_key: string
  overview_key: string
  why_visit_key: string
  latitude: number | null
  longitude: number | null
  sea_score: number | null
  silence_score: number | null
  internet_score: number | null
  safety_score: number | null
  solar_suitability: string | null
  shade: string | null
  crowd_level: string | null
  ducato_accessibility: string | null
  ducato_access: string | null
  road_surface: string | null
  road_width: string | null
  steep_grade: boolean | null
  hairpins: boolean | null
  cliff_exposure: boolean | null
  guardrails: boolean | null
  turnaround_possible: boolean | null
  last_mile_note_key: string | null
  supply_note_key: string | null
  decision_summary_key: string | null
  drone_suitability: string | null
  best_sunrise_key: string
  best_sunset_key: string
  created_at: string
  updated_at: string
}
...
export type CampingSpotRow = VerificationColumns & {
  ...
  longitude: number
  overview_key: string
  price_note_key: string
  access_note_key: string
  rating: number
  recommended: boolean
  position: number
  ducato_access: string | null
  ...
  waste_available: boolean | null
  mobile_signal: string | null
  crowd_level: string | null
  night_quiet: boolean | null
...
type InsertRow<Row> = Omit<Row, Extract<keyof Row, AutoColumns>> &
  Partial<Pick<Row, Extract<keyof Row, AutoColumns>>>
type Table<Row> = {
  Row: Row
  Insert: InsertRow<Row>
  Update: Partial<InsertRow<Row>>
  Relationships: []
}
