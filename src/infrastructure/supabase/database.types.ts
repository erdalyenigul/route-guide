...
export type StopRow = VerificationColumns & {
  id: string; slug: string; content_key: string; title_key: string; region_key: string; overview_key: string; why_visit_key: string; latitude: number | null; longitude: number | null; sea_score: number | null; silence_score: number | null; internet_score: number | null; safety_score: number | null; solar_suitability: string | null; shade: string | null; crowd_level: string | null; ducato_accessibility: string | null; drone_suitability: string | null; best_sunrise_key: string; best_sunset_key: string; created_at: string; updated_at: string
}
...
export type CampingSpotRow = VerificationColumns & {
  id: string; stop_id: string; slug: string; content_key: string; title_key: string; spot_type: string; latitude: number; longitude: number; overview_key: string; price_note_key: string; access_note_key: string; rating: number; recommended: boolean; position: number; created_at: string; updated_at: string
}
