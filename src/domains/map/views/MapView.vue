...
<style scoped>
.map-screen{position:relative;width:100%;height:calc(100dvh - 62px - 82px - env(safe-area-inset-bottom));overflow:hidden}.map-topbar{position:absolute;z-index:4;top:16px;left:16px;right:16px;display:flex;justify-content:space-between;align-items:start;pointer-events:none}.map-topbar>div,.map-topbar .v-btn{pointer-events:auto}.map-topbar>div{max-width:min(76%,480px);padding:14px 18px;border:1px solid rgba(255,255,255,.13);border-radius:20px;color:#fff;background:rgba(13,22,17,.78);box-shadow:0 14px 38px rgba(0,0,0,.22);backdrop-filter:blur(22px) saturate(135%)}.map-topbar h1{font-size:1.2rem;letter-spacing:-.025em}.map-topbar p{margin-top:4px;color:rgba(255,255,255,.7);font-size:.82rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}@media(min-width:960px){.map-screen{height:calc(100dvh - 62px - 82px)}}
</style>
