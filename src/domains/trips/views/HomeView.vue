...
@media(min-width:761px){.chapter{overflow:visible}.chapter.open{z-index:20}.chapter.open .drawer-content{position:absolute;top:100%;left:-1px;width:calc(100% + 2px);padding:0 20px 20px;border:1px solid rgba(var(--chapter-accent),.62);border-top-color:rgba(var(--chapter-accent),.2);border-radius:0 0 var(--app-radius-md) var(--app-radius-md);background:linear-gradient(145deg,rgba(var(--chapter-accent),.08),rgb(var(--v-theme-surface)) 48%);box-shadow:0 24px 54px rgba(0,0,0,.42)}}
