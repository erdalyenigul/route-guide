...
<template>
  <v-card class="stop-sheet" :class="{ collapsed: !isOpen }">
    <button
      v-if="!isOpen"
      class="sheet-reopen"
      type="button"
    ...
    <template v-else>
      <button class="sheet-handle" type="button" :aria-label="t('map.collapseStopCard')" @click="isOpen = false">
        <span />
