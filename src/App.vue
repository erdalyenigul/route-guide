...
@media(min-width:960px){.mobile-nav{left:50%!important;bottom:16px!important;width:min(680px,calc(100% - 40px))!important;height:76px!important;padding:6px!important;border:1px solid rgba(var(--v-border-color),.13);border-radius:24px!important;transform:translateX(-50%);box-shadow:var(--app-shadow-float)!important}.mobile-nav .v-btn{min-height:62px}}
