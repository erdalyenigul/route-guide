...
@media(min-width:960px){.mobile-nav{right:0!important;left:0!important;bottom:16px!important;width:min(760px,calc(100% - 40px))!important;height:76px!important;margin-inline:auto!important;padding:6px!important;border:1px solid rgba(var(--v-border-color),.13);border-radius:24px!important;box-shadow:var(--app-shadow-float)!important}.mobile-nav :deep(.v-bottom-navigation__content){display:grid;grid-template-columns:repeat(5,minmax(0,1fr));align-items:stretch;width:100%}.mobile-nav .v-btn{width:100%;min-height:62px}.mobile-nav .v-btn :deep(.v-btn__content){flex-direction:row;gap:9px}}
